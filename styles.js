...
:root {
  ...
  --secondary-color: #ff6611;
  --accent-color: #ff0000;
  --dark-bg: #14151b;
  --dark-bg-lighter: #161821;
  --card-bg: #252525;
  --text-color: #FFFFFF;
...
.hero-slide.active {
  pointer-events: auto; /* Solo el slide activo es clickeable */
  opacity: 1;
  z-index: 2;
}
...
.hero-content {
  padding: 0 30px 80px; /* Ajusta el padding-bottom para dejar espacio para los botones */
  margin-top: 20px;
...
.hero-buttons {
  ...
  z-index: 3; /* Asegura que estén por encima del overlay */
  width: 100%;
}
...
.service-item {
  ...
  min-width: 0; /* Permite que los elementos se reduzcan más allá de su contenido */
}

.service-logo {
  height: auto; /* Altura automática para mantener proporción */
  width: 100%; /* Ancho al 100% del contenedor padre */
  max-width: 80px; /* Limita el tamaño máximo */
  min-width: 30px; /* Establece un tamaño mínimo */
...
.service-item.active .service-logo {
  ...
  transform: scale(1.1); /* Le da un pequeño efecto de crecimiento */
...
.trending-card-container {
    display: flex;
    align-items: center; /* Centra verticalmente el número y el poster */
    margin-bottom: 20px; /* Espaciado entre tarjetas */
}

.trending-number {
    font-size: 10rem; /* Tamaño del número */
    font-weight: bold; /* Negrita */
    color: #000; /* Color secundario */
    width: 100px; /* Ancho fijo para el número */
    text-shadow: -1px -1px 0 #ffffff, 1px -1px 0 #ffffff, -1px 1px 0 #ffffff, 1px 1px 0 #ffffff;
    text-align: right;
    letter-spacing: -30px;
    margin-right: 10px; /* Espacio entre el número y el poster */
    margin-left: -10px;
}
...
@media (min-width: 769px) {
    .bottom-nav {
        display: none; /* Ocultar el menú inferior en pantallas grandes */
    }
    .nav-links {
        display: flex; /* Mostrar el menú superior */
      	gap: 1.5rem;
    }
    body {
...
.floating-donation-btn {
  position: fixed;
  bottom: 5rem; /* Ajusta según la altura del bottom-nav */
  left: 1rem;
  background-color: var(--secondary-color);
  color: white;
  width: 50px;
...
.bottom-nav-item-tv {
    ...
    font-weight: 500;
    transition: color 0.3s ease;
    text-decoration: none; /* Asegúrate de que el texto no tenga subrayado */
    padding: 5px;
    border-radius: 8px;
}
...
.card-nuevo-pegatina {
  position: absolute;
  bottom: 8px; /* Ajusta la posición vertical */
  left: 8px; /* Ajusta la posición horizontal */
  background-color: var(--secondary-color); /* Color secundario, naranja */
  color: white;
  padding: 4px 8px;
  border-radius: 4px;
  font-size: 0.7rem;
  font-weight: bold;
  z-index: 5; /* Asegura que esté por encima del póster */
  box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2);
}
...
#message-modal .modal-container {
  max-width: 400px; /* Ajusta el ancho para mensajes */
}

#message-modal .modal-header {
  border-bottom: none; /* Opcional: quitar la línea divisoria si el título es suficiente */
...
#message-modal .modal-body {
  padding-top: 0; /* Ajustar padding si el título está en el header */
  text-align: center;
}

#message-modal .modal-footer {
  border-top: none; /* Opcional: quitar la línea divisoria */
...
#message-modal.info .modal-title {
  color: var(--secondary-color); /* O un color neutro */
}
...
.modal-content-inner {
    ...
    flex-direction: column;
    padding: 0rem;
    margin-top: 0vh; /* Push content down below the backdrop */
}
...
.modal-main-content, .modal-sidebar-content {
    display: contents;
}

.related-desktop {
    display: none; /* Hide desktop related content on mobile */
}

.related-mobile {
    display: block; /* Show mobile related content */
	padding-left: 1rem;
    padding-right: 1rem;
  	border-top: 1px solid var(--border-color);
}
...
@media (min-width: 768px) {
  ...
  .hero-buttons {
    ...
    .modal-backdrop {
        display: none; /* No backdrop overlay needed for desktop layout */
    }
    ...
    .related-content-container.related-desktop .related-content-grid {
        ...
        padding-bottom: 0rem;
        gap: 0.5rem;
        scroll-snap-type: x mandatory; /* As per request */
    }
    
    .related-content-container.related-desktop .related-card {
      flex: 0 0 150px;
      scroll-snap-align: start; /* For scroll snap */
    }
...
@media (max-width: 768px) {
  ...
  *::-webkit-scrollbar {
  ...
  .main-container {
    padding: 0 2%;
    margin-top: 50px; /* Ajusta este valor según la altura de tu header fijo */
  }
  .nav-links {
    display: none;
  }
  .header-actions .menu-toggle {
      display: none; /* Ocultar el botón de menú lateral si ya no existe */
  }
  ...
  .floating-donation-btn {
    bottom: 5rem; /* Ajusta para que no se solape con el bottom-nav */
  }
